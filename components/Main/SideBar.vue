<template>
  <div class="w-full flex flex-col xl:items-start items-center">
    <div class="flex my-2">
      <a
        href="#"
      ...
      >
        ...
        <span class="text-twitter hidden xl:flex font-bold text-xl"
          >Beranda</span
        >
      </a>
    </div>
    ...
    >
      ...
      <svg
        ...
        height="26px"
        width="26px"
        class="fill-current text-white xl:hidden"
      >
        <g>
          <path
...
export default {
  ...
  methods: {
    showModal() {
      this.$store.commit("tweet/showModal", true);
    },
  },
};
</script>
